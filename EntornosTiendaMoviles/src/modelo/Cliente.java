...
/**
 * Clase que representa a un Cliente y su relación con artículos y ventas en el
 * sistema.
 * 
 * Esta clase almacena información personal del cliente (como ID, DNI, nombre y
 * correo), así como detalles de artículos asociados (marca, modelo, precio,
 * etc.) y datos de ventas. Proporciona métodos getter y setter para acceder y
 * modificar todos sus atributos.
 * 
 * 
 * @author rocki
 * @version 1.0
